        ...
        extends TestFunctionsBase
{
    ...
    {
        assertFunction("datediff('2020-06-18 10:30', '2020-05-15 10:30:15')", INTEGER, 34);
        assertFunction("datediff(DATE '2020-06-18', DATE '2020-05-15')", INTEGER, 34);
        assertFunction("datediff(TIMESTAMP '2020-06-18 10:30', TIMESTAMP '2020-05-15 10:30:15')", INTEGER, 34);

        assertFunction("datediff('2020-06-18 10:30', DATE '2020-05-15')", INTEGER, 34);
        assertFunction("datediff(DATE '2020-05-15', '2020-06-18 10:30')", INTEGER, -34);
        assertFunction("datediff('2020-06-18 10:30', TIMESTAMP '2020-05-15 10:30')", INTEGER, 34);
        assertFunction("datediff(TIMESTAMP '2020-05-15 10:30', '2020-06-18 10:30')", INTEGER, -34);
    }
